...
unidentified <- c(
  "Latent SES: Education and Income are proxies. Conditioning on children of a latent common cause does not close the backdoor hPDI <- SES -> CMD. Residual socioeconomic confounding is structural and cannot be removed by adjustment.",
  "Latent health-behaviour orientation: same argument for Smoking, Alcohol, PhysAct and Supplements.",
